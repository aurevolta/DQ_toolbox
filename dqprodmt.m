function A = dqprodmt(a)
% DQPRODMT Dual quaternion product matrix (-T)
%
% A = DQPRODMT(a) computes the dual quaternion multiplication matrix form of a [8x1]
% if a is a matrix [8xn] the output A will be [8x8xn]. 
% Supports also symbolic variables. 
%
% see also DQDIVMT, DQDIVM, DQDIVP, DQDIVPT, DQPRODM, DQPRODP, DQPRODPT.
