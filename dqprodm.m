function A = dqprodm(a)
% DQPRODM Dual quaternion product matrix (-)
%
% A = DQPRODM(a) computes the dual quaternion multiplication matrix form of a [8x1]
% if a is a matrix [8xn] the output A will be [8x8xn]. 
% Supports also symbolic variables. 
%
% see also DQDIVMT, DQDIVM, DQDIVP, DQDIVPT, DQPRODMT, DQPRODP, DQPRODPT.
